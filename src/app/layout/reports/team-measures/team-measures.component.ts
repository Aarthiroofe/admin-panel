...
@Component({
  selector: 'app-team-measures',
  templateUrl: './team-measures.component.html',
  styleUrls: ['./team-measures.component.scss']
})
export class TeamMeasuresComponent implements OnInit {
  ListData:any=[];
  UserData:any=[];
